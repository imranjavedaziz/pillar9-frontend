...
const Page = ({
  ...
  useEffect(() => {
    ...
    if (
      selectedStateFromDropdown.length === 0 ||
      selectedStateFromDropdown.value === "united states"
    ) {
      getPractitionerList();
    } else {
  ...
  }, [selectedStateFromDropdown, practitionerType]);
  ...
  // console.log("----", practitionerType);

  return (
    <div className="text-black lg:max-w-[1200px] mx-6 relative  border-[2px] border-solid border-[#e6d466] mb-5 rounded-[24px]">
      <div className="w-full py-10 px-[1rem]  xl:px-[2.5rem] min-h-[400px] rounded-[24px] bg-white">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex ">
                    ...
                    <div className="ms-2 flex flex-col justify-center ">
                      ...
                      <div className="">
                        ...
                        <p className="whitespace-normal break-words text-[0.75rem] text-black">
                  ...
                  <Link
                    href={`/dashboard/user-detail/${
                      practitioner?.id || practitioner?.user?.id
                    }`}
                  >
                    <button
                      type="button"
        ...
        {isDataLoaded && filterPractitionerList.length > 15 && (
          <div className="w-full mt-8 flex justify-center gap-4 [&>*]:border-0 [&>*]:cursor-pointer text-black">
            <button
